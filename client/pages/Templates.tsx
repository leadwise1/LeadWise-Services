      ...
      {previewMode === "list" ? (
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex gap-3 mt-3">
                      <a
                        ...
                        className="flex-1 border-2 border-primary text-primary hover:bg-primary hover:text-white font-semibold py-2 px-4 rounded-lg transition-colors duration-200 text-center text-sm"
                      >
                        Resume
                      </a>
                      <a
                        href={`/cover-letter?template=${template.id}`}
                        className="flex-1 border-2 border-primary text-primary hover:bg-primary hover:text-white font-semibold py-2 px-4 rounded-lg transition-colors duration-200 text-center text-sm"
                      >
                        Cover Letter
                      </a>
        ...
        <div className="py-8">
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 flex gap-4 justify-center">
            <a href={`/editor?template=${selectedTemplate}`} className="bg-primary hover:bg-opacity-90 text-white font-semibold py-3 px-8 rounded-lg transition-colors duration-200 inline-block">
              Create Resume
            </a>
            <a href={`/cover-letter?template=${selectedTemplate}`} className="bg-primary hover:bg-opacity-90 text-white font-semibold py-3 px-8 rounded-lg transition-colors duration-200 inline-block">
              Create Cover Letter
            </a>
