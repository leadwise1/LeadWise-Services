...
// --- CONFIGURATION START ---
// IMPORTANT: Keys are loaded from environment variables for security.
...
export default function Courses() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <title>Free Tech Courses | LeadWise Foundation</title>
        <meta name="description" content="Free, self-paced courses in Frontend Development and Data Analytics. Google-verified curriculum designed for women and marginalized voices in STEM." />
        <meta name="keywords" content="free coding courses, women in tech, frontend development, data analytics, google certificates, non-profit education" />
        
        {/* Open Graph / Social Media */}
        <meta property="og:title" content="Free Tech Courses | LeadWise Foundation" />
        <meta property="og:description" content="Master Frontend Dev and Data Analytics for free. Join the movement." />
        <meta property="og:image" content="https://services.letsleadwise.org/leadwise-logo.svg" />
        <meta property="og:type" content="website" />
        <link rel="canonical" href="https://services.letsleadwise.org/courses" />
      </Helmet>
      ...
      <footer className="bg-primary text-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex flex-col items-center border-t border-primary/20 pt-8">
            <p className="text-center text-sm">&copy; 2026 LeadWise Foundation. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
