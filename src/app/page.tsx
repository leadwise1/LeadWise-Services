...
// --- CONFIGURATION ---
// Note: In Next.js, env variables must start with NEXT_PUBLIC_ to be visible in the browser.
...
export default function AdminPage() {
  ...
  const fetchData = async () => {
    if (!db) return alert("Database not connected. Check API Keys in .env.local");
